...
<main class="container">
    ...
    <form action="./?action=postuler" method="POST" id="formulaire_postulation">
        <fieldset class="fieldset_profil">
            ...
            <div class="champ_formulaire_postulation">
                ...
                <textarea name="contenu_postulation" id="postulation" maxlength="750" rows="16" cols="50" required></textarea>
    ...
    <p class="message"><?php if (isset($_SESSION["message_postulation_envoyee"])) {
