                    ...
                    <li>
                        ...
                        <section class="boutons_edition">
                            ...
                            <form action="./?action=profil" method="POST" id="editer_pseudo_<?= $id ?>" class="formulaire_edition cache">
                                ...
                                <input type="text" name="nouveau_pseudo_perso" placeholder="Nouveau pseudo" aria-label="Nouveau pseudo de votre personnage <?= ucfirst($pseudo_personnage[$i]["pseudo_personnage"]) ?>" required>
                            ...
                            <form action="./?action=profil" method="POST" id="editer_royaume_<?= $id ?>" class="formulaire_edition cache">
                                <input type="hidden" name="id_personnage" value="<?= $id; ?>">
                                <input type="text" name="nouveau_royaume" placeholder="Nouveau royaume" aria-label="Nouveau royaume de votre personnage <?= ucfirst($pseudo_personnage[$i]["pseudo_personnage"]) ?>" required>
    ...
    <section id="reglages_compte">
        ...
        <section class="edition_mot_de_passe">
            ...
            <form action="./?action=profil" method="POST" id="editer_changer_mdp_<?= $id_membre ?>" class="formulaire_edition cache">
                ...
                <input type="password" name="nouveau_mot_de_passe" placeholder="Nouveau mot de passe" aria-label="Votre nouveau mot de passe" required>
